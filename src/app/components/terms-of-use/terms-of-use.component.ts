...
Service Providers using Breedly agree to:

6.1 Accurate Service Listings
- Provide truthful, accurate, and complete information about all services offered.
- Only list services you are genuinely able to provide.
- Keep service status (active/inactive) current and accurate.
- Use accurate pricing, location, and category information.

6.2 Licensing and Compliance
- Comply with all applicable federal, state, and local laws and regulations 
  governing the services you offer (e.g., licensing requirements for veterinary 
  services, pet transport, or animal care).
- Maintain any required professional licenses, certifications, or permits for 
  your service category.

6.3 Honest Communication
- Respond to messages from pet owners and breeders in good faith.
- Honor commitments made to clients regarding scheduled or confirmed services.
- Not engage in deceptive pricing, bait-and-switch tactics, or misrepresentation 
  of your services.

6.4 Location Accuracy
- Provide accurate location information for the areas where you offer services.
- Service locations are geocoded and used to enable proximity-based discovery 
  by pet owners and breeders.

6.5 Contact Information
- Contact information you provide (phone number, email, website) will be displayed 
  publicly on your Service Provider profile.
- You are responsible for ensuring this information is accurate and kept up to date.
- Do not include contact information belonging to another person without their consent.
...
profile information, service listings). By submitting content, you grant Breedly 
a non-exclusive, royalty-free, worldwide license to display, store, and use that 
...
- Not include personal contact information in public listing descriptions
  (use the messaging system instead; Service Providers may publish contact 
  information on their profile as described in Section 6.5).
...
Service Provider accounts are currently free; paid plans for Service Providers 
...
10.1 Platform Role
Breedly is a marketplace platform connecting breeders, pet seekers, and service 
providers. We do not breed, sell, or take custody of any animals. We do not 
provide pet-related services directly. We are not a party to any transaction or 
service arrangement between users.
...
10.4 Pet Services
Breedly does not verify the credentials, licenses, insurance, or quality of any 
service provider listed on the platform. Pet owners and breeders are solely 
responsible for conducting their own due diligence before engaging any service 
provider. Breedly is not liable for any harm, loss, or damage arising from 
...
- Harm arising from pet services arranged through the platform.
